...
const ITEMS = [
  ...
  },
  {
    ...
    tags:     ['Armes', 'Bâton Puissant', 'Palier 1', 'Rare'],
  ...
  },
  {
    ...
    tags:     ['Armes', 'Bâton Puissant', 'Palier 1', 'Mythique'],
    obtain:   "Obtenable en réussissant le Donjon Kobold"
  },
  {
    id:       'arc_nodachi',
    name:     "Arc Nodachi",
    ...
    palier:   1,
    image:    null,
    lore:     "Arc crée à l'aide de fragments et de minerais de Nodachite. Puissant, mais ce n'est toutefois plus qu'une relique pour le moment.",
    tags:     ['Armes', 'Arc', 'Palier 1', 'Mythique'],
    obtain:   "Obtenable en réussissant le Donjon Kobold"
  },
  {
    id:       'bouclier_nodachi',
    name:     "Bouclier Nodachi",
    rarity:   'mythique',
    category: 'arme',
    palier:   1,
    image:    null,
    lore:     "Érodé par le temps et la poussière, ce bouclier était perdu à travers le temps et les dimensions.",
    tags:     ['Armes', 'Bouclier', 'Palier 1', 'Mythique'],
    obtain:   "Obtenable en réussissant le Donjon Kobold"
  },
  {
    id:       'épée_nodachi',
    ...
    image:    null,
    lore:     null,
    tags:     ['Armes', 'Épée', 'Palier 1', 'Mythique'],
    obtain:   "Obtenable en réussissant le Donjon Kobold"
  },
  {
    id:       'hache_illfang',
    ...
    palier:   1,
    image:    null,
    lore:     "Longue et lourdre hache du puissant boss palier : Illfang the Kobold Lord !",
    tags:     ['Armes', 'Épée', 'Palier 1', 'Légendaire'],
    obtain:   "Obtenable en réussissant le Donjon Kobold"
  },
  {
    id:       'dague_nodachi',
