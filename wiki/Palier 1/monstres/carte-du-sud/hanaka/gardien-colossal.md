...
<p align="center">1288,3157<br>1069,3252<br>1246,2974</p>
{% endcolumn %}

{% column %}
<h4 align="center">⏱️ <mark style="color:purple;">Temps de Réapparition</mark></h4>

<p align="center">180 Secondes ↔ 3 Minutes</p>
{% endcolumn %}
{% endcolumns %}
...
| ------------------------------------------------------: | ------------------ |
| 🍄 <mark style="color:$danger;">Mycélium Magique</mark> | 20%                |

<h2 align="center">Butin Secret</h2>

|                                                   Butin | Pourcentage Chance |
| ------------------------------------------------------: | ------------------ |
| 🔨 <mark style="color:green;">Marteau du Colosse</mark> | ?%                 |
